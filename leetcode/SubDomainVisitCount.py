...
sdvc = SubDomainVisitCount()
print(sdvc.subdomaincnt(["9001 discuss.leetcode.com"]))
print(sdvc.subdomaincnt(["900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"]))
